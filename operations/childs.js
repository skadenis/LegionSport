...
module.exports = class childs {
    ...
    static async get_child_client_lessons(data){
        ...
        await asyncForEach(lessons, async function (lesson, key){
            ...
            start_lesson_time = new Date(start_lesson_time).getTime();
            console.log(stop_show_videolink_time);
            stop_show_videolink_time = new Date(stop_show_videolink_time).getTime();
    ...
    static async get_child_info(data){
        ...
        if(childsA.length > 0){
            ...
            childsA[0].wallet = Math.round(childsA[0].wallet * 100) / 100;
